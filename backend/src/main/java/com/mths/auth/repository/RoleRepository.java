package com.mths.auth.repository;//package com.digi_dokita.repository;
//
...
public interface RoleRepository extends JpaRepository<Role, Long> {
    ...
    List<Role> findByPermissionName(@Param("permissionName") com.mths.auth.entity.Permission.PermissionName permissionName);
