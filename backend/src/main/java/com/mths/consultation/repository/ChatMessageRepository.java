...
public interface ChatMessageRepository extends JpaRepository<ChatMessage, Long> {
    ...
    List<ChatMessage> findByConsultationAndStatus(@Param("consultation") VideoConsultation consultation, @Param("status") com.mths.shared.constants.MessageStatus status);
