...
@Data
@Schema(description = "Request to create a pharmacist profile")
public class CreatePharmacistProfileRequest {

    @Schema(description = "Pharmacy ID where pharmacist works", example = "1")
    private Long pharmacyId;

    @Schema(description = "Pharmacist license number", example = "PCN-123456", required = true)
    @NotBlank(message = "License number is required")
    private String licenseNumber;

    @Schema(description = "Professional registration number", example = "REG-789012", required = true)
    ...
    @Schema(description = "Phone number", example = "+234-801-234-5678", required = true)
    ...
    @Schema(description = "Address", example = "123 Pharmacy Street, Lagos", required = true)
    ...
    private Boolean isSuperintendent = false;
