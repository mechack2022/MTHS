...
import com.auth.service.mapper.ChatMessageMapper;
import com.auth.service.mapper.FileAttachmentMapper;
...
public class ChatMessageServiceImpl implements ChatMessageService {
    ...
    @Override
    public ChatMessageDTO sendMessage(Long consultationId, com.auth.service.controller.ChatController.SendMessageRequest request) {
        ...
        message.setMessageType(request.messageType() != null ? 
            com.auth.service.constants.MessageType.valueOf(request.messageType()) : 
            com.auth.service.constants.MessageType.TEXT);
        message.setStatus(com.auth.service.constants.MessageStatus.SENT);
    ...
    @Override
    public ChatMessageDTO sendMessageWithAttachment(Long consultationId, com.auth.service.controller.ChatController.SendMessageRequest request, MultipartFile attachment) {
        ...
        message.setMessageType(com.auth.service.constants.MessageType.FILE);
        message.setStatus(com.auth.service.constants.MessageStatus.SENT);
        message.setSentAt(LocalDateTime.now());
    ...
    public ChatMessageDTO markMessageAsRead(Long messageId, Long userId) {
        ...
        if (!message.getSenderId().equals(userId)) {
            ...
            message.setStatus(com.auth.service.constants.MessageStatus.READ);
            ChatMessage saved = chatMessageRepository.save(message);
    ...
    public ChatMessageDTO updateMessageStatus(Long messageId, String status) {
        ...
        message.setStatus(com.auth.service.constants.MessageStatus.valueOf(status.toUpperCase()));
    ...
    @Override
    public ChatMessageDTO editMessage(Long messageId, com.auth.service.controller.ChatController.EditMessageRequest request) {
        ChatMessage message = chatMessageRepository.findById(messageId)
            .orElseThrow(() -> new ResourceNotFoundException("ChatMessage", "id", messageId));
    ...
    public FileAttachmentDTO uploadFile(Long consultationId, MultipartFile file, Long uploaderId, String uploaderType, String description, Boolean isMedicalRecord) {
        ...
        try {
            ...
            com.auth.service.dto.FileUploadResponse uploadResponse = fileUploadService.uploadFile(file, com.auth.service.constants.FileCategory.CONSULTATION_ATTACHMENT);
